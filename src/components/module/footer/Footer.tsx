      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="/books" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                Books
              </a>
            </li>

            <li>
              <a href="/borrow-summary" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                Borrow Summary
              </a>
            </li>
          </ul>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
          &copy; 2022. Book-Cart. All rights reserved.
        </p>
      </div>
    </div>
  </div>
